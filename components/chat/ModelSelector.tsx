      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute bottom-full right-0 mb-2 w-64 bg-white border border-[#e2e8f0] rounded-xl shadow-xl z-50 overflow-hidden"
          >
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-1.5">
                        <span className="text-[13px] font-medium text-[#0f172a]">{model.name}</span>
